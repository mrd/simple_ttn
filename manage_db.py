...
def create_tables_if_necessary(db):
    ...
    db.execute('create table if not exists device_location (start timestamp default current_timestamp, finish timestamp, device_id string, room string, detailed_location string, private bool)')
